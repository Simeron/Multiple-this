...
// Find the multiples / pass through the right numbers to evalueate 
export const MultipleList = () => {
    ...
    // Fuctionility to handle the selected number and to show to the user the multiples of the number selected
